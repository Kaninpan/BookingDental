<?php
    ...
    if(isset($_POST['submit'])){
      ...
      mysqli_query($conn,"update `user_info` set  nametitle = '$nametitle', name = '$name', IDcard = '$IDcard', Tel = '$Tel', HBD = '$HBD', SexBG = '$SexBG'  WHERE id = '$id'") or die('query failed');
      echo '<script type="text/javascript">'; 
      echo 'alert("ทำการแก้ไขข้อมูลผู้ใช้แล้วเรียบร้อย");'; 
...
<meta charset="UTF-8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Itim&family=Prompt&display=swap" rel="stylesheet">
        ...
        <div class="sidebar">
            ...
            <a class="active" href="dtadmin-profile.php">ย้อนกลับ</a>
        </div>

        <div class="content" style="background: #C3C3C3">
        <h1 style="font-size:60px;">แก้ไขข้อมูลผู้ใช้งาน</h1>
        <div class="form-containerLG">
        <h3><b>ข้อมูลเดิม</b></h3>
        <form action="" method="post" enctype='multipart/form-data'>
                    <input type="text" name="nametitle" required placeholder="กรอกชื่อและนามสกุลของท่าน" value="<?php echo $row['nametitle']; ?>"class="box" disabled><br>
                    <input type="text" name="name" class="box" required value="<?php echo $row['name']; ?>" disabled>
                    <input type="text" name="IDcard" class="box" value="<?php echo $row['IDcard']; ?>" disabled>
                    <input type="text" name="Tel" class="box" required value="<?php echo $row['Tel']; ?>" disabled>
                    <input type="text" name="HBD" class="box" required value="<?php echo $row['HBD']; ?>" disabled>
                    <input type="text" name="SexBG" class="box" required value="<?php echo $row['SexBG']; ?>" disabled><br><br>
                      <hr>
                      <br>
                    ...
                    <select style="width: 6%;" name="birth_date" class="box2" required>
                     ...
                     <select style="width: 6%;" name="birth_year" class="box2" required>
                      ...
                      <hr>
                      <br><br>
                      <p>โปรดตรวจสอบการแก้ไขให้เรียบร้อยก่อนทำการแก้ไขข้อมูล</p><br>
